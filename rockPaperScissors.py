...
Second, we will create code that takes the input(choices)
Third, we will create code that takes 'input'(choices)
...
Sixth, we will add statements at the end and the beginning that welcomes and thank the user playing
...
while(keepPlaying):
    ...
    while(humanScore < 2 and cpuScore < 2):
        ...
        if(choice.lower() == "q"):
        ...
        elif((choice.lower() == 'rock' and cpuChoice == 1) or (choice.lower() == 'scissors' and cpuChoice == 3) or (choice.lower() == 'paper' and cpuChoice == 3)):
            print("DRAW")
            ...
            print("Human:" + humanScore.__str__() + " CPU: " + cpuChoice.__str__())
